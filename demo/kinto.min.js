...
(function (global){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _slicedToArray=function(){function e(e,t){var n=[],r=!0,i=!1,a=void 0;try{for(var s,u=e[Symbol.iterator]();!(r=(s=u.next()).done)&&(n.push(s.value),!t||n.length!==t);r=!0);}catch(d){i=!0,a=d}finally{try{!r&&u["return"]&&u["return"]()}finally{if(i)throw a}}return n}return function(t,n){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),_events=require("events"),_uuid=require("uuid"),_deepEql=require("deep-eql"),_deepEql2=_interopRequireDefault(_deepEql),_utils=require("./utils"),_api=require("./api"),_adaptersIDB=require("./adapters/IDB"),_adaptersIDB2=_interopRequireDefault(_adaptersIDB);_utils.attachFakeIDBSymbolsTo("object"==typeof global?global:window);var SyncResultObject=function(){function e(){_classCallCheck(this,e),Object.assign(this,e.defaults)}return _createClass(e,[{key:"add",value:function(e,t){Array.isArray(this[e])&&(this[e]=this[e].concat(t),this.ok=this.errors.length+this.conflicts.length===0)}}],[{key:"defaults",get:function(){return{ok:!0,lastModified:null,errors:[],created:[],updated:[],deleted:[],published:[],conflicts:[],skipped:[]}}}]),e}();exports.SyncResultObject=SyncResultObject;var Collection=function(){function e(t,n,r){var i=void 0===arguments[3]?{}:arguments[3];_classCallCheck(this,e),this._bucket=t,this._name=n,this._lastModified=null,this.db=new _adaptersIDB2["default"](t+"/"+n),this.api=r,this.events=i.events||new _events.EventEmitter}return _createClass(e,[{key:"clear",value:function(){return this.db.clear().then(function(){return{data:[],permissions:{}}})}},{key:"create",value:function(e){var t=void 0===arguments[1]?{forceUUID:!1,synced:!1}:arguments[1];if("object"!=typeof e)return Promise.reject(new Error("Record is not an object."));var n=Object.assign({},e,{id:t.synced||t.forceUUID?e.id:_uuid.v4(),_status:t.synced?"synced":"created"});return _utils.isUUID4(n.id)?this.db.create(n).then(function(e){return{data:e,permissions:{}}}):Promise.reject(new Error("Invalid UUID: "+n.id))}},{key:"update",value:function(e){var t=this,n=void 0===arguments[1]?{synced:!1}:arguments[1];return"object"!=typeof e?Promise.reject(new Error("Record is not an object.")):e.id?_utils.isUUID4(e.id)?this.get(e.id).then(function(r){var i="updated";"deleted"===e._status?i="deleted":n.synced&&(i="synced");var a=Object.assign({},e,{_status:i});return t.db.update(a).then(function(e){return{data:e,permissions:{}}})}):Promise.reject(new Error("Invalid UUID: "+e.id)):Promise.reject(new Error("Cannot update a record missing id."))}},{key:"resolve",value:function(e,t){return this.update(Object.assign({},t,{last_modified:e.remote.last_modified}))}},{key:"get",value:function(e){var t=void 0===arguments[1]?{includeDeleted:!1}:arguments[1];return _utils.isUUID4(e)?this.db.get(e).then(function(n){if(!n||!t.includeDeleted&&"deleted"===n._status)throw new Error("Record with id="+e+" not found.");return{data:n,permissions:{}}}):Promise.reject(Error("Invalid UUID: "+e))}},{key:"delete",value:function(e){var t=this,n=void 0===arguments[1]?{virtual:!0}:arguments[1];return _utils.isUUID4(e)?this.get(e,{includeDeleted:!0}).then(function(r){return n.virtual?"deleted"===r.data._status?Promise.resolve({data:{id:e},permissions:{}}):t.update(Object.assign({},r.data,{_status:"deleted"})):t.db["delete"](e).then(function(e){return{data:{id:e},permissions:{}}})}):Promise.reject(new Error("Invalid UUID: "+e))}},{key:"list",value:function(){var e=void 0===arguments[0]?{}:arguments[0],t=void 0===arguments[1]?{includeDeleted:!1}:arguments[1];return e=Object.assign({order:"-last_modified",filters:{}},e),this.db.list().then(function(n){var r=_utils.reduceRecords(e.filters,e.order,n);return t.includeDeleted||(r=r.filter(function(e){return"deleted"!==e._status})),{data:r,permissions:{}}})}},{key:"_importChange",value:function(e){var t=this;return this.get(e.id,{includeDeleted:!0}).then(function(n){return"synced"!==n.data._status?"deleted"===n.data._status?{type:"skipped",data:n.data}:_deepEql2["default"](_api.cleanRecord(n.data),_api.cleanRecord(e))?t.update(e,{synced:!0}).then(function(e){return{type:"updated",data:e.data}}):{type:"conflicts",data:{type:"incoming",local:n.data,remote:e}}:e.deleted?t["delete"](e.id,{virtual:!1}).then(function(e){return{type:"deleted",data:e.data}}):t.update(e,{synced:!0}).then(function(e){return{type:"updated",data:e.data}})})["catch"](function(n){return/not found/i.test(n.message)?e.deleted?{type:"skipped",data:e}:t.create(e,{synced:!0}).then(function(e){return{type:"created",data:e.data}}):{type:"errors",data:n}})}},{key:"importChanges",value:function(e,t){var n=this;return Promise.all(t.changes.map(function(e){return n._importChange(e)})).then(function(t){var n=!0,r=!1,i=void 0;try{for(var a,s=t[Symbol.iterator]();!(n=(a=s.next()).done);n=!0){var u=a.value;e.add(u.type,u.data)}}catch(d){r=!0,i=d}finally{try{!n&&s["return"]&&s["return"]()}finally{if(r)throw i}}return e}).then(function(e){return e.lastModified=t.lastModified,e.conflicts.length>0?e:n.db.saveLastModified(e.lastModified).then(function(t){return n._lastModified=t,e})})}},{key:"gatherLocalChanges",value:function(){return this.list({},{includeDeleted:!0}).then(function(e){return e.data.reduce(function(e,t){return"deleted"!==t._status||t.last_modified?"synced"!==t._status&&e.toSync.push(t):e.toDelete.push(t),e},{toDelete:[],toSync:[]})})}},{key:"pullChanges",value:function(e){var t=this,n=void 0===arguments[1]?{}:arguments[1];return n=Object.assign({lastModified:this.lastModified},n),this.api.fetchChangesSince(this.bucket,this.name,n).then(function(n){return t.importChanges(e,n)})}},{key:"pushChanges",value:function(t){var n=this,r=void 0===arguments[1]?{}:arguments[1],i=r.strategy===e.SERVER_WINS;return r=Object.assign({safe:i},r),this.gatherLocalChanges().then(function(e){var t=e.toDelete,i=e.toSync;return Promise.all([Promise.all(t.map(function(e){return n["delete"](e.id,{virtual:!1})})),n.api.batch(n.bucket,n.name,i,r)])}).then(function(e){var r=_slicedToArray(e,2),i=(r[0],r[1]);return t.add("errors",i.errors),t.add("conflicts",i.conflicts),Promise.all(i.published.map(function(e){return e.deleted?n["delete"](e.id,{virtual:!1}).then(function(e){return{data:{id:e.data.id,deleted:!0}}}):n.update(e,{synced:!0})})).then(function(e){return t.add("published",e.map(function(e){return e.data})),t})})}},{key:"sync",value:function(){var t=this,n=void 0===arguments[0]?{strategy:e.strategy.MANUAL,headers:{},ignoreBackoff:!1}:arguments[0];if(!n.ignoreBackoff&&this.api.backoff>0){var r=Math.ceil(this.api.backoff/1e3);return Promise.reject(new Error("Server is backed off; retry in "+r+"s or use the ignoreBackoff option."))}var i=new SyncResultObject;return this.db.getLastModified().then(function(e){return t._lastModified=e}).then(function(e){return t.pullChanges(i,n)}).then(function(e){return e.ok?t.pushChanges(e,n).then(function(e){return t.pullChanges(e,n)}):e})}},{key:"name",get:function(){return this._name}},{key:"bucket",get:function(){return this._bucket}},{key:"lastModified",get:function(){return this._lastModified}}],[{key:"strategy",get:function(){return{CLIENT_WINS:"client_wins",SERVER_WINS:"server_wins",MANUAL:"manual"}}}]),e}();exports["default"]=Collection;
