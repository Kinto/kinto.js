...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function request(e){var r,t,s,n,o=void 0===arguments[1]?{headers:{}}:arguments[1];return o.headers=Object.assign({},DEFAULT_REQUEST_HEADERS,o.headers),fetch(e,o).then(function(e){return r=e,n=e.headers,t=e.status,s=e.statusText,0==n.get("Content-Length")?null:e.json()})["catch"](function(e){var s=new Error("HTTP "+(t||0)+"; "+e);throw s.response=r,s.stack=e.stack,s}).then(function(e){if(t>=400){var o="HTTP "+t+"; ";e.errno&&e.errno in _errorsJs2["default"]?(o+=_errorsJs2["default"][e.errno],e.message&&(o+=": "+e.message)):o+=s||"";var a=new Error(o.trim());throw a.response=r,a.data=e,a}return{status:t,json:e,headers:n}})}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=request;var _errorsJs=require("./errors.js"),_errorsJs2=_interopRequireDefault(_errorsJs),DEFAULT_REQUEST_HEADERS={Accept:"application/json","Content-Type":"application/json"};exports.DEFAULT_REQUEST_HEADERS=DEFAULT_REQUEST_HEADERS;
