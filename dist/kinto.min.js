...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function cleanRecord(e){var t=void 0===arguments[1]?RECORD_FIELDS_TO_CLEAN:arguments[1];return Object.keys(e).reduce(function(r,s){return-1===t.indexOf(s)&&(r[s]=e[s]),r},{})}function request(e){var t,r,s,n,o=void 0===arguments[1]?{headers:{}}:arguments[1];return o.headers=Object.assign({},DEFAULT_REQUEST_HEADERS,o.headers),fetch(e,o).then(function(e){return t=e,n=e.headers,r=e.status,s=e.statusText,0==n.get("Content-Length")?null:e.json()})["catch"](function(e){var s=new Error("HTTP "+(r||0)+"; "+e);throw s.response=t,s.stack=e.stack,s}).then(function(e){if(r>=400){var o="HTTP "+r+"; ";e.errno&&e.errno in _errorsJs2["default"]?(o+=_errorsJs2["default"][e.errno],e.message&&(o+=": "+e.message)):o+=s||"";var i=new Error(o.trim());throw i.response=t,i.data=e,i}return{status:r,json:e,headers:n}})}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var s=t[r];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,r,s){return r&&e(t.prototype,r),s&&e(t,s),t}}();exports.cleanRecord=cleanRecord,exports.request=request;var _utilsJs=require("./utils.js"),_errorsJs=require("./errors.js"),_errorsJs2=_interopRequireDefault(_errorsJs),RECORD_FIELDS_TO_CLEAN=["_status","last_modified"],SUPPORTED_PROTOCOL_VERSION="v1";exports.SUPPORTED_PROTOCOL_VERSION=SUPPORTED_PROTOCOL_VERSION;var DEFAULT_REQUEST_HEADERS={Accept:"application/json","Content-Type":"application/json"};exports.DEFAULT_REQUEST_HEADERS=DEFAULT_REQUEST_HEADERS;var Api=function(){function e(t){var r=void 0===arguments[1]?{headers:{}}:arguments[1];if(_classCallCheck(this,e),"string"!=typeof t||!t.length)throw new Error("Invalid remote URL: "+t);this.remote=t,this.optionHeaders=r.headers,this.serverSettings=null;try{this.version=t.match(/\/(v\d+)\/?$/)[1]}catch(s){throw new Error("The remote URL must contain the version: "+t)}if(this.version!==SUPPORTED_PROTOCOL_VERSION)throw new Error("Unsupported protocol version: "+this.version)}return _createClass(e,[{key:"endpoints",value:function(){var e=void 0===arguments[0]?{fullUrl:!0}:arguments[0],t=e.fullUrl?this.remote:"/"+this.version,r={root:function(){return t+"/"},batch:function(){return t+"/batch"},bucket:function(e){return t+"/buckets/"+e},collection:function(e,t){return r.bucket(e)+"/collections/"+t},records:function(e,t){return r.collection(e,t)+"/records"},record:function(e,t,s){return r.records(e,t)+"/"+s}};return r}},{key:"fetchServerSettings",value:function(){var e=this;return this.serverSettings?Promise.resolve(this.serverSettings):request(this.endpoints().root()).then(function(t){return e.serverSettings=t.json.settings,e.serverSettings})}},{key:"fetchChangesSince",value:function(e,t){var r=void 0===arguments[2]?{lastModified:null,headers:{}}:arguments[2],s=this.endpoints().records(e,t),n="",o=Object.assign({},this.optionHeaders,r.headers);return r.lastModified&&(n="?_since="+r.lastModified,o["If-None-Match"]=_utilsJs.quote(r.lastModified)),this.fetchServerSettings().then(function(e){return request(s+n,{headers:o})}).then(function(e){if(304===e.status)return{lastModified:r.lastModified,changes:[]};var t=e.headers.get("ETag");return{lastModified:t?parseInt(_utilsJs.unquote(t),10):r.lastModified,changes:e.json.data}})}},{key:"_buildRecordBatchRequest",value:function(e,t,r){var s="deleted"===e._status,n=s?"DELETE":"PUT",o=s?void 0:{data:cleanRecord(e)},i={};return r&&(e.last_modified?i["If-Match"]=_utilsJs.quote(e.last_modified):s||(i["If-None-Match"]="*")),{method:n,headers:i,path:t,body:o}}},{key:"batch",value:function(e,t,r){var s=this,n=void 0===arguments[3]?{headers:{}}:arguments[3],o=n.safe||!0,i=Object.assign({},this.optionHeaders,n.headers),a={errors:[],published:[],conflicts:[],skipped:[]};return r.length?this.fetchServerSettings().then(function(n){return request(s.endpoints().batch(),{method:"POST",headers:i,body:JSON.stringify({defaults:{headers:i},requests:r.map(function(r){var n=s.endpoints({full:!1}).record(e,t,r.id);return s._buildRecordBatchRequest(r,n,o)})})})}).then(function(e){var t=(e.status,e.json);e.headers;return t.responses.forEach(function(e,t){e.status&&e.status>=200&&e.status<400?a.published.push(e.body.data):404===e.status?a.skipped.push(e.body):412===e.status?a.conflicts.push({type:"outgoing",local:r[t],remote:e.body}):a.errors.push({path:e.path,sent:r[t],error:e.body})}),a}):Promise.resolve(a)}}]),e}();exports["default"]=Api;
