...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function cleanRecord(e){var r=void 0===arguments[1]?RECORD_FIELDS_TO_CLEAN:arguments[1];return Object.keys(e).reduce(function(t,n){return-1===r.indexOf(n)&&(t[n]=e[n]),t},{})}function _handleServerError(e,r){var t=void 0===arguments[2]?{prefix:""}:arguments[2],n=t.prefix+" HTTP "+e.status+" ";r.errno&&_errorsJs2["default"].hasOwnProperty(r.errno)&&(n+=_errorsJs2["default"][r.errno]);var s=new Error(n.trim());throw s.data=r,s}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}();exports.cleanRecord=cleanRecord;var _utilsJs=require("./utils.js"),_errorsJs=require("./errors.js"),_errorsJs2=_interopRequireDefault(_errorsJs),SUPPORTED_PROTOCOL_VERSION="v1";exports.SUPPORTED_PROTOCOL_VERSION=SUPPORTED_PROTOCOL_VERSION;var RECORD_FIELDS_TO_CLEAN=["_status","last_modified"],DEFAULT_REQUEST_HEADERS={Accept:"application/json","Content-Type":"application/json"},Api=function(){function e(r){var t=void 0===arguments[1]?{headers:{}}:arguments[1];if(_classCallCheck(this,e),"string"!=typeof r||!r.length)throw new Error("Invalid remote URL: "+r);this.remote=r,this.optionHeaders=t.headers;try{this.version=r.match(/\/(v\d+)\/?$/)[1]}catch(n){throw new Error("The remote URL must contain the version: "+r)}if(this.version!==SUPPORTED_PROTOCOL_VERSION)throw new Error("Unsupported protocol version: "+this.version)}return _createClass(e,[{key:"endpoints",value:function(){var e=void 0===arguments[0]?{fullUrl:!0}:arguments[0],r=e.fullUrl?this.remote:"/"+this.version,t={root:function(){return r},batch:function(){return r+"/batch"},bucket:function(e){return r+"/buckets/"+e},collection:function(e,r){return t.bucket(e)+"/collections/"+r},records:function(e,r){return t.collection(e,r)+"/records"},record:function(e,r,n){return t.records(e,r)+"/"+n}};return t}},{key:"fetchChangesSince",value:function(e,r){var t,n,s=void 0===arguments[2]?{lastModified:null,headers:{}}:arguments[2],o=this.endpoints().records(e,r),a="Fetching changes failed:",i="",u=Object.assign({},DEFAULT_REQUEST_HEADERS,this.optionHeaders,s.headers);return s.lastModified&&(i="?_since="+s.lastModified,u["If-None-Match"]=_utilsJs.quote(s.lastModified)),fetch(o+i,{headers:u}).then(function(e){return n=e,304===n.status?(t=s.lastModified,{data:[]}):n.json()})["catch"](function(e){throw new Error(a+": HTTP "+n.status+"; "+e)}).then(function(e){if(n.status>=400)_handleServerError(n,e,{prefix:a});else{var r=n.headers.get("ETag");r&&(t=parseInt(_utilsJs.unquote(r),10))}return{lastModified:t,changes:e.data}})}},{key:"_buildRecordBatchRequest",value:function(e,r,t){var n="deleted"===e._status,s=n?"DELETE":"PUT",o=n?void 0:{data:cleanRecord(e)},a={};return t&&(e.last_modified?a["If-Match"]=_utilsJs.quote(e.last_modified):n||(a["If-None-Match"]="*")),{method:s,headers:a,path:r,body:o}}},{key:"batch",value:function(e,r,t){var n,s=this,o=void 0===arguments[3]?{headers:{}}:arguments[3],a=o.safe||!0,i="BATCH request failed:",u=Object.assign({},DEFAULT_REQUEST_HEADERS,this.optionHeaders,o.headers),c={errors:[],published:[],conflicts:[],skipped:[]};return t.length?fetch(this.endpoints().batch(),{method:"POST",headers:u,body:JSON.stringify({defaults:{headers:u},requests:t.map(function(t){var n=s.endpoints({full:!1}).record(e,r,t.id);return s._buildRecordBatchRequest(t,n,a)})})}).then(function(e){return n=e,e.json()})["catch"](function(e){throw new Error(i+" HTTP "+n.status+"; "+e)}).then(function(e){return n.status>=400&&_handleServerError(n,e,{prefix:i}),e.responses.forEach(function(e,r){e.status&&e.status>=200&&e.status<400?c.published.push(e.body.data):404===e.status?c.skipped.push(e.body):412===e.status?c.conflicts.push({type:"outgoing",local:t[r],remote:e.body}):c.errors.push({path:e.path,sent:t[r],error:e.body})}),c}):Promise.resolve(c)}}]),e}();exports["default"]=Api;
