...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _inherits(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);e.prototype=Object.create(r&&r.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),r&&(Object.setPrototypeOf?Object.setPrototypeOf(e,r):e.__proto__=r)}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _get=function(e,r,t){for(var n=!0;n;){var o=e,u=r,a=t;i=c=s=void 0,n=!1,null===o&&(o=Function.prototype);var i=Object.getOwnPropertyDescriptor(o,u);if(void 0!==i){if("value"in i)return i.value;var s=i.get;return void 0===s?void 0:s.call(a)}var c=Object.getPrototypeOf(o);if(null===c)return void 0;e=c,r=u,t=a,n=!0}},_createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}(),_baseJs=require("./base.js"),_baseJs2=_interopRequireDefault(_baseJs),Batch=function(){function e(r,t){_classCallCheck(this,e),this._transaction=r,this._store=t,this._operations=[],this._errors=[]}return _createClass(e,[{key:"abort",value:function(){this._operations.length=0,this._transaction.abort()}},{key:"get",value:function(e){var r=this;return e?new Promise(function(t,n){var o=r._store.get(e);o.onerror=function(e){return n(e.target.error)},o.onsuccess=function(){return t(o.result)}}):Promise.reject(new Error("Id not provided."))}},{key:"list",value:function(){var e=this;return new Promise(function(r,t){var n=[],o=e._store.openCursor();o.onerror=function(e){return t(e.target.error)},o.onsuccess=function(e){var t=e.target.result;t?(n.push(t.value),t["continue"]()):r(n)}})}},{key:"_schedule",value:function(r,t){var n=this,o={type:r,data:t};return this._operations.push(o),new Promise(function(u,a){var i=e.BATCH_STORE_METHODS[r];try{var s=n._store[i](t);s.onerror=function(e){n._errors.push(e.target.error),a(e.target.error)},s.onsuccess=function(e){return u(o)}}catch(c){c.operation=o,n._errors.push(c),a(event.target.err)}})}},{key:"clear",value:function(){return this._schedule("clear")}},{key:"create",value:function(e){return this._schedule("create",e)}},{key:"update",value:function(e){return this._schedule("update",e)}},{key:"delete",value:function(e){return this._schedule("delete",e)}},{key:"execute",value:function(e){var r=this;return Promise.resolve(e(this)).then(function(e){return new Promise(function(t,n){var o=function(e){return t({result:e,operations:r._operations,errors:r._errors})};r._transaction.onerror=function(t){r._errors=r._errors.concat({type:"error",error:t.target.error}),o(e)},r._transaction.onabort=function(){return o(e)},r._transaction.oncomplete=function(){return o(e)}})})["catch"](function(e){return console.log(e),{result:void 0,operations:r._operations,errors:r._errors.concat(e)}})}}],[{key:"BATCH_STORE_METHODS",get:function(){return{clear:"clear",create:"add",update:"put","delete":"delete"}}}]),e}(),IDB=function(e){function r(e){_classCallCheck(this,r),_get(Object.getPrototypeOf(r.prototype),"constructor",this).call(this),this._db=null,this.dbname=e}return _inherits(r,e),_createClass(r,[{key:"_handleError",value:function(e){return function(r){var t=new Error(e+"() "+r);throw t.stack=r.stack,t}}},{key:"open",value:function(){var e=this;return this._db?Promise.resolve(this):new Promise(function(r,t){var n=indexedDB.open(e.dbname,1);n.onupgradeneeded=function(r){var t=r.target.result,n=t.createObjectStore(e.dbname,{keyPath:"id"});n.createIndex("id","id",{unique:!0}),n.createIndex("_status","_status"),n.createIndex("last_modified","last_modified");var o=t.createObjectStore("__meta__",{keyPath:"name"});o.createIndex("name","name",{unique:!0})},n.onerror=function(e){return t(e.target.error)},n.onsuccess=function(t){e._db=t.target.result,r(e)}})}},{key:"prepare",value:function(){var e=arguments.length<=0||void 0===arguments[0]?void 0:arguments[0],r=arguments.length<=1||void 0===arguments[1]?null:arguments[1],t=r||this.dbname,n=e?this._db.transaction([t],e):this._db.transaction([t]),o=n.objectStore(t);return{transaction:n,store:o}}},{key:"batch",value:function(e){var r=this;return this.open().then(function(){var t=r.prepare("readwrite"),n=t.transaction,o=t.store,u=new Batch(n,o);return u.execute(e)})}},{key:"clear",value:function(){return this.batch(function(e){return e.clear()}).then(function(e){if(e.errors.length>0)throw e.errors[0]})["catch"](this._handleError("clear"))}},{key:"create",value:function(e){return this.batch(function(r){return r.create(e)}).then(function(e){if(e.errors.length>0)throw e.errors[0];return e.result.data})["catch"](this._handleError("create"))}},{key:"update",value:function(e){return this.batch(function(r){return r.update(e)}).then(function(e){if(e.errors.length>0)throw e.errors[0];return e.result.data})["catch"](this._handleError("update"))}},{key:"get",value:function(e){return this.batch(function(r){return r.get(e)}).then(function(e){if(e.errors.length>0)throw e.errors[0];return e.result})["catch"](this._handleError("get"))}},{key:"delete",value:function(e){return this.batch(function(r){return r["delete"](e)}).then(function(e){if(e.errors.length>0)throw e.errors[0];return e.result.data})["catch"](this._handleError("delete"))}},{key:"list",value:function(){return this.batch(function(e){return e.list()}).then(function(e){if(e.errors.length>0)throw e.errors[0];return e.result})["catch"](this._handleError("list"))}},{key:"saveLastModified",value:function(e){var r=this,t=parseInt(e,10);return this.open().then(function(){return new Promise(function(e,n){var o=r.prepare("readwrite","__meta__"),u=o.transaction,a=o.store;a.put({name:"lastModified",value:t}),u.onerror=function(e){return n(e.target.error)},u.oncomplete=function(r){return e(t)}})})}},{key:"getLastModified",value:function(){var e=this;return this.open().then(function(){return new Promise(function(r,t){var n=e.prepare(void 0,"__meta__"),o=n.transaction,u=n.store,a=u.get("lastModified");o.onerror=function(e){return t(e.target.error)},o.oncomplete=function(e){r(a.result&&a.result.value||null)}})})}}]),r}(_baseJs2["default"]);exports["default"]=IDB,module.exports=exports["default"];
