...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function cleanRecord(e){var t=void 0===arguments[1]?RECORD_FIELDS_TO_CLEAN:arguments[1];return Object.keys(e).reduce(function(r,s){return-1===t.indexOf(s)&&(r[s]=e[s]),r},{})}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var s=t[r];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,r,s){return r&&e(t.prototype,r),s&&e(t,s),t}}();exports.cleanRecord=cleanRecord;var _utilsJs=require("./utils.js"),_errorsJs=require("./errors.js"),_errorsJs2=_interopRequireDefault(_errorsJs),_httpJs=require("./http.js"),_httpJs2=_interopRequireDefault(_httpJs),RECORD_FIELDS_TO_CLEAN=["_status","last_modified"],SUPPORTED_PROTOCOL_VERSION="v1";exports.SUPPORTED_PROTOCOL_VERSION=SUPPORTED_PROTOCOL_VERSION;var Api=function(){function e(t){var r=void 0===arguments[1]?{headers:{}}:arguments[1];if(_classCallCheck(this,e),"string"!=typeof t||!t.length)throw new Error("Invalid remote URL: "+t);"/"===t[t.length-1]&&(t=t.slice(0,-1)),this.remote=t,this.optionHeaders=r.headers,this.serverSettings=null;try{this.version=t.match(/\/(v\d+)\/?$/)[1]}catch(s){throw new Error("The remote URL must contain the version: "+t)}if(this.version!==SUPPORTED_PROTOCOL_VERSION)throw new Error("Unsupported protocol version: "+this.version);this.http=new _httpJs2["default"]}return _createClass(e,[{key:"endpoints",value:function(){var e=void 0===arguments[0]?{fullUrl:!0}:arguments[0],t=e.fullUrl?this.remote:"/"+this.version,r={root:function(){return t+"/"},batch:function(){return t+"/batch"},bucket:function(e){return t+"/buckets/"+e},collection:function(e,t){return r.bucket(e)+"/collections/"+t},records:function(e,t){return r.collection(e,t)+"/records"},record:function(e,t,s){return r.records(e,t)+"/"+s}};return r}},{key:"fetchServerSettings",value:function(){var e=this;return this.serverSettings?Promise.resolve(this.serverSettings):this.http.request(this.endpoints().root()).then(function(t){return e.serverSettings=t.json.settings,e.serverSettings})}},{key:"fetchChangesSince",value:function(e,t){var r=this,s=void 0===arguments[2]?{lastModified:null,headers:{}}:arguments[2],n=this.endpoints().records(e,t),i="",o=Object.assign({},this.optionHeaders,s.headers);return s.lastModified&&(i="?_since="+s.lastModified,o["If-None-Match"]=_utilsJs.quote(s.lastModified)),this.fetchServerSettings().then(function(e){return r.http.request(n+i,{headers:o})}).then(function(e){if(304===e.status)return{lastModified:s.lastModified,changes:[]};var t=e.headers.get("ETag");return{lastModified:t?parseInt(_utilsJs.unquote(t),10):s.lastModified,changes:e.json.data}})}},{key:"_buildRecordBatchRequest",value:function(e,t,r){var s="deleted"===e._status,n=s?"DELETE":"PUT",i=s?void 0:{data:cleanRecord(e)},o={};return r&&(e.last_modified?o["If-Match"]=_utilsJs.quote(e.last_modified):s||(o["If-None-Match"]="*")),{method:n,headers:o,path:t,body:i}}},{key:"_processBatchResponses",value:function(e,t,r){var s=(r.status,r.json);r.headers;return s.responses.forEach(function(r,s){r.status&&r.status>=200&&r.status<400?e.published.push(r.body.data):404===r.status?e.skipped.push(r.body):412===r.status?e.conflicts.push({type:"outgoing",local:t[s],remote:r.body.details&&r.body.details.existing||null}):e.errors.push({path:r.path,sent:t[s],error:r.body})}),e}},{key:"batch",value:function(e,t,r){var s=this,n=void 0===arguments[3]?{headers:{}}:arguments[3],i=n.safe||!0,o=Object.assign({},this.optionHeaders,n.headers),u={errors:[],published:[],conflicts:[],skipped:[]};return r.length?this.fetchServerSettings().then(function(a){var c=a["cliquet.batch_max_requests"];return c&&r.length>c?Promise.all(_utilsJs.partition(r,c).map(function(r){return s.batch(e,t,r,n)})).then(function(e){return e.reduce(function(e,t){return Object.keys(t).forEach(function(r){e[r]=u[r].concat(t[r])}),e},u)}):s.http.request(s.endpoints().batch(),{method:"POST",headers:o,body:JSON.stringify({defaults:{headers:o},requests:r.map(function(r){var n=s.endpoints({full:!1}).record(e,t,r.id);return s._buildRecordBatchRequest(r,n,i)})})}).then(function(e){return s._processBatchResponses(u,r,e)})}):Promise.resolve(u)}}]),e}();exports["default"]=Api;

},{"./errors.js":112,"./http.js":113,"./utils.js":115}],111:[function(require,module,exports){
(function (global){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _slicedToArray=function(){function e(e,t){var r=[],n=!0,a=!1,i=void 0;try{for(var o,s=e[Symbol.iterator]();!(n=(o=s.next()).done)&&(r.push(o.value),!t||r.length!==t);n=!0);}catch(u){a=!0,i=u}finally{try{!n&&s["return"]&&s["return"]()}finally{if(a)throw i}}return r}return function(t,r){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,r);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_uuid=require("uuid"),_deepEql=require("deep-eql"),_deepEql2=_interopRequireDefault(_deepEql),_utils=require("./utils"),_api=require("./api");_utils.attachFakeIDBSymbolsTo("object"==typeof global?global:window);var SyncResultObject=function(){function e(){_classCallCheck(this,e),Object.assign(this,e.defaults)}return _createClass(e,[{key:"add",value:function(e,t){Array.isArray(this[e])&&(this[e]=this[e].concat(t),this.ok=this.errors.length+this.conflicts.length===0)}}],[{key:"defaults",get:function(){return{ok:!0,lastModified:null,errors:[],created:[],updated:[],deleted:[],published:[],conflicts:[],skipped:[]}}}]),e}();exports.SyncResultObject=SyncResultObject;var Collection=function(){function e(t,r,n){_classCallCheck(this,e),this._bucket=t,this._name=r,this._db,this.api=n,this._lastModified=null}return _createClass(e,[{key:"_handleError",value:function(e){return function(t){throw new Error(e+"() "+t.message)}}},{key:"open",value:function(){var e=this;return this._db?Promise.resolve(this):new Promise(function(t,r){var n=indexedDB.open(e.dbname,1);n.onupgradeneeded=function(t){var r=t.target.result,n=r.createObjectStore(e.dbname,{keyPath:"id"});n.createIndex("id","id",{unique:!0}),n.createIndex("_status","_status"),n.createIndex("last_modified","last_modified");var a=r.createObjectStore("__meta__",{keyPath:"name"});a.createIndex("name","name",{unique:!0})},n.onerror=function(e){return r(e.target.error)},n.onsuccess=function(r){e._db=r.target.result,t(e)}})}},{key:"prepare",value:function(){var e=void 0===arguments[0]?void 0:arguments[0],t=void 0===arguments[1]?null:arguments[1],r=t||this.dbname,n=this._db.transaction([r],e),a=n.objectStore(r);return{transaction:n,store:a}}},{key:"clear",value:function(){var e=this;return this.open().then(function(){return new Promise(function(t,r){var n=e.prepare("readwrite"),a=n.transaction,i=n.store;i.clear(),a.onerror=function(e){return r(new Error(e.target.error))},a.oncomplete=function(e){t({data:[],permissions:{}})}})})["catch"](this._handleError("clear"))}},{key:"create",value:function(e){var t=this,r=void 0===arguments[1]?{forceUUID:!1,synced:!1}:arguments[1];return this.open().then(function(){return"object"!=typeof e?Promise.reject(new Error("Record is not an object.")):new Promise(function(n,a){var i=t.prepare("readwrite"),o=i.transaction,s=i.store,u=Object.assign({},e,{id:r.synced||r.forceUUID?e.id:_uuid.v4(),_status:r.synced?"synced":"created"});_utils.isUUID4(u.id)||a(new Error("Invalid UUID: "+u.id)),s.add(u),o.onerror=function(e){return a(new Error(e.target.error))},o.oncomplete=function(e){n({data:u,permissions:{}})}})})["catch"](this._handleError("create"))}},{key:"update",value:function(e){var t=this,r=void 0===arguments[1]?{synced:!1}:arguments[1];return this.open().then(function(){return"object"!=typeof e?Promise.reject(new Error("Record is not an object.")):e.id?_utils.isUUID4(e.id)?t.get(e.id).then(function(n){return new Promise(function(n,a){var i="updated";"deleted"===e._status?i="deleted":r.synced&&(i="synced");var o=t.prepare("readwrite"),s=o.transaction,u=o.store,c=Object.assign({},e,{_status:i}),d=u.put(c);s.onerror=function(e){return a(new Error(e.target.error))},s.oncomplete=function(e){n({data:Object.assign({},c,{id:d.result}),permissions:{}})}})}):Promise.reject(new Error("Invalid UUID: "+e.id)):Promise.reject(new Error("Cannot update a record missing id."))})["catch"](this._handleError("update"))}},{key:"resolve",value:function(e,t){return this.update(Object.assign({},t,{last_modified:e.remote.last_modified}))}},{key:"get",value:function(e){var t=this,r=void 0===arguments[1]?{includeDeleted:!1}:arguments[1];return this.open().then(function(){if(!_utils.isUUID4(e))throw new Error("Invalid UUID: "+e);return new Promise(function(n,a){var i=t.prepare(),o=i.transaction,s=i.store,u=s.get(e);o.onerror=function(e){return a(new Error(e.target.error))},o.oncomplete=function(t){!u.result||!r.includeDeleted&&"deleted"===u.result._status?a(new Error("Record with id="+e+" not found.")):n({data:u.result,permissions:{}})}})})["catch"](this._handleError("get"))}},{key:"delete",value:function(e){var t=this,r=void 0===arguments[1]?{virtual:!0}:arguments[1];return this.open().then(function(){if(!_utils.isUUID4(e))throw new Error("Invalid UUID: "+e);return t.get(e,{includeDeleted:!0}).then(function(n){return r.virtual?"deleted"===n.data._status?Promise.resolve({data:{id:e},permissions:{}}):t.update(Object.assign({},n.data,{_status:"deleted"})):new Promise(function(r,n){var a=t.prepare("readwrite"),i=a.transaction,o=a.store;o["delete"](e),i.onerror=function(e){return n(new Error(e.target.error))},i.oncomplete=function(t){r({data:{id:e},permissions:{}})}})})})["catch"](this._handleError("delete"))}},{key:"list",value:function(){var e=this,t=void 0===arguments[0]?{}:arguments[0],r=void 0===arguments[1]?{includeDeleted:!1}:arguments[1];return t=Object.assign({order:"-last_modified",filters:{}},t),this.open().then(function(){return new Promise(function(n,a){var i=[],o=e.prepare(),s=o.transaction,u=o.store,c=u.openCursor();c.onsuccess=function(e){var t=e.target.result;t&&((r.includeDeleted||"deleted"!==t.value._status)&&i.push(t.value),t["continue"]())},s.onerror=function(e){return a(new Error(e.target.error))},s.oncomplete=function(e){n({data:_utils.reduceRecords(t.filters,t.order,i),permissions:{}})}})})["catch"](this._handleError("list"))}},{key:"_importChange",value:function(e){var t=this;return this.get(e.id,{includeDeleted:!0}).then(function(r){return"synced"!==r.data._status?"deleted"===r.data._status?{type:"skipped",data:r.data}:_deepEql2["default"](_api.cleanRecord(r.data),_api.cleanRecord(e))?t.update(e,{synced:!0}).then(function(e){return{type:"updated",data:e.data}}):{type:"conflicts",data:{type:"incoming",local:r.data,remote:e}}:e.deleted?t["delete"](e.id,{virtual:!1}).then(function(e){return{type:"deleted",data:e.data}}):t.update(e,{synced:!0}).then(function(e){return{type:"updated",data:e.data}})})["catch"](function(r){return/not found/i.test(r.message)?e.deleted?{type:"skipped",data:e}:t.create(e,{synced:!0}).then(function(e){return{type:"created",data:e.data}}):{type:"errors",data:r}})}},{key:"importChanges",value:function(e,t){var r=this;return Promise.all(t.changes.map(function(e){return r._importChange(e)})).then(function(t){var r=!0,n=!1,a=void 0;try{for(var i,o=t[Symbol.iterator]();!(r=(i=o.next()).done);r=!0){var s=i.value;e.add(s.type,s.data)}}catch(u){n=!0,a=u}finally{try{!r&&o["return"]&&o["return"]()}finally{if(n)throw a}}return e}).then(function(e){return e.lastModified=t.lastModified,e.conflicts.length>0?e:r.saveLastModified(e.lastModified).then(function(t){return e})})}},{key:"saveLastModified",value:function(e){var t=this,r=parseInt(e,10);return this.open().then(function(){return new Promise(function(e,n){var a=t.prepare("readwrite","__meta__"),i=a.transaction,o=a.store;o.put({name:"lastModified",value:r});i.onerror=function(e){return n(e.target.error)},i.oncomplete=function(n){t._lastModified=r,e(r)}})})}},{key:"getLastModified",value:function(){var e=this;return this.open().then(function(){return new Promise(function(t,r){var n=e.prepare(void 0,"__meta__"),a=n.transaction,i=n.store,o=i.get("lastModified");a.onerror=function(e){return r(e.target.error)},a.oncomplete=function(e){t(o.result&&o.result.value||null)}})})}},{key:"gatherLocalChanges",value:function(){return this.list({},{includeDeleted:!0}).then(function(e){return e.data.reduce(function(e,t){return"deleted"!==t._status||t.last_modified?"synced"!==t._status&&e.toSync.push(t):e.toDelete.push(t),e},{toDelete:[],toSync:[]})})}},{key:"pullChanges",value:function(e){var t=this,r=void 0===arguments[1]?{}:arguments[1];return r=Object.assign({lastModified:this.lastModified},r),this.api.fetchChangesSince(this.bucket,this.name,r).then(function(r){return t.importChanges(e,r)})}},{key:"pushChanges",value:function(t){var r=this,n=void 0===arguments[1]?{}:arguments[1],a=n.strategy===e.SERVER_WINS;return n=Object.assign({safe:a},n),this.gatherLocalChanges().then(function(e){var t=e.toDelete,a=e.toSync;return Promise.all([Promise.all(t.map(function(e){return r["delete"](e.id,{virtual:!1})})),r.api.batch(r.bucket,r.name,a,n)])}).then(function(e){var n=_slicedToArray(e,2),a=(n[0],n[1]);return t.add("errors",a.errors),t.add("conflicts",a.conflicts),Promise.all(a.published.map(function(e){return e.deleted?r["delete"](e.id,{virtual:!1}).then(function(e){return{data:{id:e.data.id,deleted:!0}}}):r.update(e,{synced:!0})})).then(function(e){return t.add("published",e.map(function(e){return e.data})),t})})}},{key:"sync",value:function(){var t=this,r=void 0===arguments[0]?{strategy:e.strategy.MANUAL,headers:{},forceBackoff:!1}:arguments[0];if(this.api.backoffRelease&&!r.forceBackoff){var n=_utils.getUnixTime();if(n<this.api.backoffRelease){var a=this.api.backoffRelease-n;return Promise.reject(new Error("Server is backed off; retry in "+a+"s or use the forceBackoff option."))}}var i=new SyncResultObject;return this.getLastModified().then(function(e){return t._lastModified=e}).then(function(e){return t.pullChanges(i,r)}).then(function(e){return e.ok?t.pushChanges(e,r).then(function(e){return t.pullChanges(e,r)}):e})}},{key:"name",get:function(){return this._name}},{key:"bucket",get:function(){return this._bucket}},{key:"dbname",get:function(){return this.bucket+"/"+this.name}},{key:"lastModified",get:function(){return this._lastModified}}],[{key:"strategy",get:function(){return{CLIENT_WINS:"client_wins",SERVER_WINS:"server_wins",MANUAL:"manual"}}}]),e}();exports["default"]=Collection;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function _inherits(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);e.prototype=Object.create(r&&r.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),r&&(e.__proto__=r)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}(),_get=function(e,r,t){for(var n=!0;n;){var o=e,a=r,s=t;u=c=i=void 0,n=!1,null===o&&(o=Function.prototype);var u=Object.getOwnPropertyDescriptor(o,a);if(void 0!==u){if("value"in u)return u.value;var i=u.get;return void 0===i?void 0:i.call(s)}var c=Object.getPrototypeOf(o);if(null===c)return void 0;e=c,r=a,t=s,n=!0}},_utils=require("./utils"),_errorsJs=require("./errors.js"),_errorsJs2=_interopRequireDefault(_errorsJs),_events=require("events"),HTTP=function(e){function r(){var e=void 0===arguments[0]?{backoffRelease:null}:arguments[0];_classCallCheck(this,r),_get(Object.getPrototypeOf(r.prototype),"constructor",this).call(this),this._backoffRelease=e.backoffRelease}return _inherits(r,e),_createClass(r,[{key:"request",value:function(e){var t,n,o,a,s=this,u=void 0===arguments[1]?{headers:{}}:arguments[1];return u.headers=Object.assign({},r.DEFAULT_REQUEST_HEADERS,u.headers),fetch(e,u).then(function(e){t=e,a=e.headers,n=e.status,o=e.statusText,s._checkForDeprecationHeader(a),s._checkForBackoffHeader(a);var r=a.get("Content-Length");return r&&0!=r?e.json():null})["catch"](function(e){var r=new Error("HTTP "+(n||0)+"; "+e);throw r.response=t,r.stack=e.stack,r}).then(function(e){if(n>=400){var r="HTTP "+n+"; ";e.errno&&e.errno in _errorsJs2["default"]?(r+=_errorsJs2["default"][e.errno],e.message&&(r+=": "+e.message)):r+=o||"";var s=new Error(r.trim());throw s.response=t,s.data=e,s}return{status:n,json:e,headers:a}})}},{key:"_checkForDeprecationHeader",value:function(e){var r=e.get("Alert");if(r)try{var t=JSON.parse(r),n=t.message,o=t.url;console.warn(n,o)}catch(a){console.warn("Unable to parse Alert header message",r)}}},{key:"_checkForBackoffHeader",value:function(e){var r=parseInt(e.get("Backoff"),10);this._backoffRelease=r>0?_utils.getUnixTime()+r:null}},{key:"backoffRelease",get:function(){return this._backoffRelease}}],[{key:"DEFAULT_REQUEST_HEADERS",get:function(){return{Accept:"application/json","Content-Type":"application/json"}}}]),r}(_events.EventEmitter);exports["default"]=HTTP,module.exports=exports["default"];

},{"./errors.js":112,"./utils":115,"events":99}],114:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var o=0;o<t.length;o++){var i=t[o];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,o,i){return o&&e(t.prototype,o),i&&e(t,i),t}}();require("babel/polyfill"),require("isomorphic-fetch");var _api=require("./api"),_api2=_interopRequireDefault(_api),_collection=require("./collection"),_collection2=_interopRequireDefault(_collection),DEFAULT_BUCKET_NAME="default",Kinto=function(){function e(){var t=void 0===arguments[0]?{}:arguments[0];_classCallCheck(this,e),this._options=t,this._collections={}}return _createClass(e,[{key:"collection",value:function(e){if(!e)throw new Error("missing collection name");var t=this._options.bucket||DEFAULT_BUCKET_NAME,o=new _api2["default"](this._options.remote||"http://0.0.0.0:8888/v1",{headers:this._options.headers||{}});return this._collections.hasOwnProperty(e)||(this._collections[e]=new _collection2["default"](t,e,o)),this._collections[e]}}]),e}();exports["default"]=Kinto,module.exports=exports["default"];

},{"./api":110,"./collection":111,"babel/polyfill":94,"isomorphic-fetch":107}],115:[function(require,module,exports){
"use strict";function attachFakeIDBSymbolsTo(e){if("object"!=typeof e.indexedDB){var t=["IDBTransaction","IDBObjectStore","IDBIndex","IDBCursor","IDBCursorWithValue","IDBKeyRange"];t.forEach(function(t){var r=t.replace("IDB","FDB");e[t]=require("fake-indexeddb/lib/"+r)}),e.indexedDB=require("fake-indexeddb")}}function quote(e){return'"'+e+'"'}function unquote(e){return e.replace(/^"/,"").replace(/"$/,"")}function _isUndefined(e){return"undefined"==typeof e}function sortObjects(e,t){var r="-"===e[0],n=r?e.slice(1):e,i=r?-1:1;return t.slice().sort(function(e,t){return e[n]&&_isUndefined(t[n])?i:t[n]&&_isUndefined(e[n])?-i:_isUndefined(e[n])&&_isUndefined(t[n])?0:e[n]>t[n]?i:-i})}function filterObjects(e,t){return t.filter(function(t){return Object.keys(e).every(function(r){return t[r]===e[r]})})}function reduceRecords(e,t,r){return sortObjects(t,filterObjects(e,r))}function partition(e,t){return 0>=t?e:e.reduce(function(e,r,n){return 0===n||n%t===0?e.push([r]):e[e.length-1].push(r),e},[])}function isUUID4(e){return RE_UUID.test(e)}function getUnixTime(){return Math.floor((new Date).getTime()/1e3)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.attachFakeIDBSymbolsTo=attachFakeIDBSymbolsTo,exports.quote=quote,exports.unquote=unquote,exports.sortObjects=sortObjects,exports.filterObjects=filterObjects,exports.reduceRecords=reduceRecords,exports.partition=partition,exports.isUUID4=isUUID4,exports.getUnixTime=getUnixTime;var RE_UUID=/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;
