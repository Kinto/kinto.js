...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function cleanRecord(e){var t=void 0===arguments[1]?RECORD_FIELDS_TO_CLEAN:arguments[1];return Object.keys(e).reduce(function(r,n){return-1===t.indexOf(n)&&(r[n]=e[n]),r},{})}function _handleServerError(e,t){var r=void 0===arguments[2]?{prefix:""}:arguments[2],n=r.prefix+" HTTP "+e.status+" ";t.errno&&_errorsJs2["default"].hasOwnProperty(t.errno)&&(n+=_errorsJs2["default"][t.errno]);var s=new Error(n.trim());throw s.data=t,s}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}();exports.cleanRecord=cleanRecord;var _utilsJs=require("./utils.js"),_errorsJs=require("./errors.js"),_errorsJs2=_interopRequireDefault(_errorsJs),SUPPORTED_PROTOCOL_VERSION="v1";exports.SUPPORTED_PROTOCOL_VERSION=SUPPORTED_PROTOCOL_VERSION;var RECORD_FIELDS_TO_CLEAN=["_status","last_modified"],DEFAULT_REQUEST_HEADERS={Accept:"application/json","Content-Type":"application/json"},Api=function(){function e(t){var r=void 0===arguments[1]?{headers:{}}:arguments[1];if(_classCallCheck(this,e),"string"!=typeof t||!t.length)throw new Error("Invalid remote URL: "+t);this.remote=t,this.optionHeaders=r.headers,this.serverSettings=null;try{this.version=t.match(/\/(v\d+)\/?$/)[1]}catch(n){throw new Error("The remote URL must contain the version: "+t)}if(this.version!==SUPPORTED_PROTOCOL_VERSION)throw new Error("Unsupported protocol version: "+this.version)}return _createClass(e,[{key:"endpoints",value:function(){var e=void 0===arguments[0]?{fullUrl:!0}:arguments[0],t=e.fullUrl?this.remote:"/"+this.version,r={root:function(){return t+"/"},batch:function(){return t+"/batch"},bucket:function(e){return t+"/buckets/"+e},collection:function(e,t){return r.bucket(e)+"/collections/"+t},records:function(e,t){return r.collection(e,t)+"/records"},record:function(e,t,n){return r.records(e,t)+"/"+n}};return r}},{key:"fetchServerSettings",value:function(){var e=this;if(this.serverSettings)return Promise.resolve(this.serverSettings);var t,r="Fetching server settings failed";return fetch(this.endpoints().root(),{headers:DEFAULT_REQUEST_HEADERS}).then(function(e){return t=e,e.json()})["catch"](function(e){var n=t&&t.status||0;throw new Error(r+": HTTP "+n+"; "+e)}).then(function(t){return e.serverSettings=t.settings,e.serverSettings})}},{key:"fetchChangesSince",value:function(e,t){var r,n,s=void 0===arguments[2]?{lastModified:null,headers:{}}:arguments[2],o=this.endpoints().records(e,t),i="Fetching changes failed:",a="",u=Object.assign({},DEFAULT_REQUEST_HEADERS,this.optionHeaders,s.headers);return s.lastModified&&(a="?_since="+s.lastModified,u["If-None-Match"]=_utilsJs.quote(s.lastModified)),this.fetchServerSettings().then(function(e){return fetch(o+a,{headers:u})}).then(function(e){return n=e,304===n.status?(r=s.lastModified,{data:[]}):n.json()})["catch"](function(e){var t=n&&n.status||0;throw new Error(i+": HTTP "+t+"; "+e)}).then(function(e){if(n.status>=400)_handleServerError(n,e,{prefix:i});else{var t=n.headers.get("ETag");t&&(r=parseInt(_utilsJs.unquote(t),10))}return{lastModified:r,changes:e.data}})}},{key:"_buildRecordBatchRequest",value:function(e,t,r){var n="deleted"===e._status,s=n?"DELETE":"PUT",o=n?void 0:{data:cleanRecord(e)},i={};return r&&(e.last_modified?i["If-Match"]=_utilsJs.quote(e.last_modified):n||(i["If-None-Match"]="*")),{method:s,headers:i,path:t,body:o}}},{key:"batch",value:function(e,t,r){var n,s=this,o=void 0===arguments[3]?{headers:{}}:arguments[3],i=o.safe||!0,a="BATCH request failed:",u=Object.assign({},DEFAULT_REQUEST_HEADERS,this.optionHeaders,o.headers),c={errors:[],published:[],conflicts:[],skipped:[]};return r.length?this.fetchServerSettings().then(function(n){return fetch(s.endpoints().batch(),{method:"POST",headers:u,body:JSON.stringify({defaults:{headers:u},requests:r.map(function(r){var n=s.endpoints({full:!1}).record(e,t,r.id);return s._buildRecordBatchRequest(r,n,i)})})})}).then(function(e){return n=e,e.json()})["catch"](function(e){var t=n&&n.status||0;throw new Error(a+" HTTP "+t+"; "+e)}).then(function(e){return n.status>=400&&_handleServerError(n,e,{prefix:a}),e.responses.forEach(function(e,t){e.status&&e.status>=200&&e.status<400?c.published.push(e.body.data):404===e.status?c.skipped.push(e.body):412===e.status?c.conflicts.push({type:"outgoing",local:r[t],remote:e.body}):c.errors.push({path:e.path,sent:r[t],error:e.body})}),c}):Promise.resolve(c)}}]),e}();exports["default"]=Api;
