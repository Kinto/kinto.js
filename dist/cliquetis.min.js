...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function cleanRecord(e){var t=void 0===arguments[1]?RECORD_FIELDS_TO_CLEAN:arguments[1];return Object.keys(e).reduce(function(r,n){return-1===t.indexOf(n)&&(r[n]=e[n]),r},{})}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}();exports.cleanRecord=cleanRecord;var _utilsJs=require("./utils.js"),SUPPORTED_PROTOCOL_VERSION="v1";exports.SUPPORTED_PROTOCOL_VERSION=SUPPORTED_PROTOCOL_VERSION;var RECORD_FIELDS_TO_CLEAN=["_status","last_modified"],DEFAULT_REQUEST_HEADERS={Accept:"application/json","Content-Type":"application/json"},Api=function(){function e(t){var r=void 0===arguments[1]?{headers:{}}:arguments[1];if(_classCallCheck(this,e),"string"!=typeof t||!t.length)throw new Error("Invalid remote URL: "+t);t.lastIndexOf("/")===t.length-1&&(t=t.substr(0,t.length-1)),this.remote=t,this.optionHeaders=r.headers,this.serverVersion=null}return _createClass(e,[{key:"endpoints",value:function(){var e=void 0===arguments[0]?{fullUrl:!0}:arguments[0],t="/"+SUPPORTED_PROTOCOL_VERSION;e.fullUrl&&(t=this.remote+t);var r={root:function(){return t},batch:function(){return""+t+"/batch"},bucket:function(e){return""+t+"/buckets/"+e},collection:function(e,t){return""+r.bucket(e)+"/collections/"+t},records:function(e,t){return""+r.collection(e,t)+"/records"},record:function(e,t,n){return""+r.records(e,t)+"/"+n}};return r}},{key:"checkServerVersion",value:function(){function e(e){if(e!==SUPPORTED_PROTOCOL_VERSION)throw new Error("Unsupported protocol version: "+e);return e}var t=this;if(this.serverVersion)try{return Promise.resolve(e(this.serverVersion))}catch(r){return Promise.reject(r)}return fetch(this.remote,{headers:DEFAULT_REQUEST_HEADERS}).then(function(e){return e.json()}).then(function(r){try{t.serverVersion=r.url.match(/\/(v\d+)\/?$/)[1]}catch(n){throw new Error("Remote URL version couldn't be checked; "+n.message)}return e(t.serverVersion)})}},{key:"fetchChangesSince",value:function(e,t){var r,n=this,s=void 0===arguments[2]?{lastModified:null,headers:{}}:arguments[2];return this.checkServerVersion().then(function(){var r=n.endpoints().records(e,t),o="",i=Object.assign({},DEFAULT_REQUEST_HEADERS,n.optionHeaders,s.headers);return s.lastModified&&(o="?_since="+s.lastModified,i["If-None-Match"]=_utilsJs.quote(s.lastModified)),fetch(r+o,{headers:i})}).then(function(e){if(304===e.status)return r=s.lastModified,{data:[]};if(e.status>=400)throw new Error("Fetching changes failed: HTTP "+e.status);var t=e.headers.get("ETag");return t&&(r=parseInt(_utilsJs.unquote(t),10)),e.json()}).then(function(e){return{lastModified:r,changes:e.data}})}},{key:"_buildRecordBatchRequest",value:function(e,t,r){var n="deleted"===e._status,s=n?"DELETE":"PUT",o=n?void 0:{data:cleanRecord(e)},i={};return r&&(e.last_modified?i["If-Match"]=_utilsJs.quote(e.last_modified):n||(i["If-None-Match"]="*")),{method:s,headers:i,path:t,body:o}}},{key:"batch",value:function(e,t,r){var n=this,s=void 0===arguments[3]?{headers:{}}:arguments[3],o={errors:[],published:[],conflicts:[],skipped:[]};return this.checkServerVersion().then(function(){var i=s.safe||!0,a=Object.assign({},DEFAULT_REQUEST_HEADERS,n.optionHeaders,s.headers);return r.length?fetch(n.endpoints().batch(),{method:"POST",headers:a,body:JSON.stringify({defaults:{headers:a},requests:r.map(function(r){var s=n.endpoints({full:!1}).record(e,t,r.id);return n._buildRecordBatchRequest(r,s,i)})})}):Promise.resolve(o)}).then(function(e){return e.json()}).then(function(e){if(e.error)throw Object.keys(e).reduce(function(t,r){return"message"!==r&&(t[r]=e[r]),t},new Error("BATCH request failed: "+e.message));return e.responses.forEach(function(e){e.status&&e.status>=200&&e.status<400?o.published.push(e.body.data):404===e.status?o.skipped.push(e.body):412===e.status?o.conflicts.push({type:"outgoing",data:e.body}):o.errors.push({path:e.path,error:e.body})}),o})}}]),e}();exports["default"]=Api;

},{"./utils.js":105}],104:[function(require,module,exports){
(function (global){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _slicedToArray(e,t){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e)){var n=[],r=!0,a=!1,i=void 0;try{for(var o,u=e[Symbol.iterator]();!(r=(o=u.next()).done)&&(n.push(o.value),!t||n.length!==t);r=!0);}catch(s){a=!0,i=s}finally{try{!r&&u["return"]&&u["return"]()}finally{if(a)throw i}}return n}throw new TypeError("Invalid attempt to destructure non-iterable instance")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),_uuid=require("uuid"),_deepEql=require("deep-eql"),_deepEql2=_interopRequireDefault(_deepEql),_utils=require("./utils"),_api=require("./api");_utils.attachFakeIDBSymbolsTo("object"==typeof global?global:window);var SyncResultObject=function(){function e(){_classCallCheck(this,e),Object.assign(this,e.defaults)}return _createClass(e,[{key:"add",value:function(e,t){Array.isArray(this[e])&&(this[e]=this[e].concat(t),this.ok=this.errors.length+this.conflicts.length===0)}}],[{key:"defaults",get:function(){return{ok:!0,lastModified:null,errors:[],created:[],updated:[],deleted:[],published:[],conflicts:[],skipped:[]}}}]),e}();exports.SyncResultObject=SyncResultObject;var Collection=function(){function e(t,n,r){_classCallCheck(this,e),this._bucket=t,this._name=n,this._db,this.api=r,this._lastModified=null}return _createClass(e,[{key:"name",get:function(){return this._name}},{key:"bucket",get:function(){return this._bucket}},{key:"dbname",get:function(){return""+this.bucket+"/"+this.name}},{key:"lastModified",get:function(){return this._lastModified}},{key:"_handleError",value:function(e){return function(t){throw new Error(e+"() "+t.message)}}},{key:"open",value:function(){var e=this;return this._db?Promise.resolve(this):new Promise(function(t,n){var r=indexedDB.open(e.dbname,1);r.onupgradeneeded=function(t){var n=t.target.result,r=n.createObjectStore(e.dbname,{keyPath:"id"});r.createIndex("id","id",{unique:!0}),r.createIndex("_status","_status"),r.createIndex("last_modified","last_modified");var a=n.createObjectStore("__meta__",{keyPath:"name"});a.createIndex("name","name",{unique:!0})},r.onerror=function(e){return n(e.target.error)},r.onsuccess=function(n){e._db=n.target.result,t(e)}})}},{key:"prepare",value:function(){var e=void 0===arguments[0]?void 0:arguments[0],t=void 0===arguments[1]?null:arguments[1],n=t||this.dbname,r=this._db.transaction([n],e),a=r.objectStore(n);return{transaction:r,store:a}}},{key:"clear",value:function(){var e=this;return this.open().then(function(){return new Promise(function(t,n){var r=e.prepare("readwrite"),a=r.transaction,i=r.store;i.clear(),a.onerror=function(e){return n(new Error(e.target.error))},a.oncomplete=function(e){t({data:[],permissions:{}})}})})["catch"](this._handleError("clear"))}},{key:"create",value:function(e){var t=this,n=void 0===arguments[1]?{synced:!1}:arguments[1];return this.open().then(function(){return"object"!=typeof e?Promise.reject(new Error("Record is not an object.")):new Promise(function(r,a){var i=t.prepare("readwrite"),o=i.transaction,u=i.store,s=Object.assign({},e,{id:n.synced?e.id:_uuid.v4(),_status:n.synced?"synced":"created"});u.add(s),o.onerror=function(e){return a(new Error(e.target.error))},o.oncomplete=function(e){r({data:s,permissions:{}})}})})["catch"](this._handleError("create"))}},{key:"update",value:function(e){var t=this,n=void 0===arguments[1]?{synced:!1}:arguments[1];return this.open().then(function(){return"object"!=typeof e?Promise.reject(new Error("Record is not an object.")):e.id?t.get(e.id).then(function(r){return new Promise(function(r,a){var i="updated";"deleted"===e._status?i="deleted":n.synced&&(i="synced");var o=t.prepare("readwrite"),u=o.transaction,s=o.store,c=Object.assign({},e,{_status:i}),d=s.put(c);u.onerror=function(e){return a(new Error(e.target.error))},u.oncomplete=function(e){r({data:Object.assign({},c,{id:d.result}),permissions:{}})}})}):Promise.reject(new Error("Cannot update a record missing id."))})["catch"](this._handleError("update"))}},{key:"resolve",value:function(e,t){return this.update(Object.assign({},t,{last_modified:e.remote.last_modified}))}},{key:"get",value:function(e){var t=this,n=void 0===arguments[1]?{includeDeleted:!1}:arguments[1];return this.open().then(function(){return new Promise(function(r,a){var i=t.prepare(),o=i.transaction,u=i.store,s=u.get(e);o.onerror=function(e){return a(new Error(e.target.error))},o.oncomplete=function(t){!s.result||!n.includeDeleted&&"deleted"===s.result._status?a(new Error("Record with id="+e+" not found.")):r({data:s.result,permissions:{}})}})})["catch"](this._handleError("get"))}},{key:"delete",value:function(e){var t=this,n=void 0===arguments[1]?{virtual:!0}:arguments[1];return this.open().then(function(){return t.get(e,{includeDeleted:!0}).then(function(r){return n.virtual?"deleted"===r.data._status?Promise.resolve({data:{id:e},permissions:{}}):t.update(Object.assign({},r.data,{_status:"deleted"})):new Promise(function(n,r){var a=t.prepare("readwrite"),i=a.transaction,o=a.store;o["delete"](e),i.onerror=function(e){return r(new Error(e.target.error))},i.oncomplete=function(t){n({data:{id:e},permissions:{}})}})})})["catch"](this._handleError("delete"))}},{key:"list",value:function(){var e=this,t=(void 0===arguments[0]?{}:arguments[0],void 0===arguments[1]?{includeDeleted:!1}:arguments[1]);return this.open().then(function(){return new Promise(function(n,r){var a=[],i=e.prepare(),o=i.transaction,u=i.store,s=u.openCursor();s.onsuccess=function(e){var n=e.target.result;n&&((t.includeDeleted||"deleted"!==n.value._status)&&a.push(n.value),n["continue"]())},o.onerror=function(e){return r(new Error(e.target.error))},o.oncomplete=function(e){n({data:a,permissions:{}})}})})["catch"](this._handleError("list"))}},{key:"_importChange",value:function(e){var t=this;return this.get(e.id,{includeDeleted:!0}).then(function(n){return"synced"!==n.data._status?"deleted"===n.data._status?{type:"skipped",data:n.data}:_deepEql2["default"](_api.cleanRecord(n.data),_api.cleanRecord(e))?t.update(e,{synced:!0}).then(function(e){return{type:"updated",data:e.data}}):{type:"conflicts",data:{type:"incoming",local:n.data,remote:e}}:e.deleted?t["delete"](e.id,{virtual:!1}).then(function(e){return{type:"deleted",data:e.data}}):t.update(e,{synced:!0}).then(function(e){return{type:"updated",data:e.data}})})["catch"](function(n){return/not found/i.test(n.message)?e.deleted?{type:"skipped",data:e}:t.create(e,{synced:!0}).then(function(e){return{type:"created",data:e.data}}):{type:"errors",data:n}})}},{key:"importChanges",value:function(e,t){var n=this;return Promise.all(t.changes.map(function(e){return n._importChange(e)})).then(function(t){var n=!0,r=!1,a=void 0;try{for(var i,o=t[Symbol.iterator]();!(n=(i=o.next()).done);n=!0){var u=i.value;e.add(u.type,u.data)}}catch(s){r=!0,a=s}finally{try{!n&&o["return"]&&o["return"]()}finally{if(r)throw a}}return e}).then(function(e){return e.lastModified=t.lastModified,e.conflicts.length>0?e:n.saveLastModified(e.lastModified).then(function(t){return e})})}},{key:"saveLastModified",value:function(e){var t=this,n=parseInt(e,10);return this.open().then(function(){return new Promise(function(e,r){var a=t.prepare("readwrite","__meta__"),i=a.transaction,o=a.store;o.put({name:"lastModified",value:n});i.onerror=function(e){return r(e.target.error)},i.oncomplete=function(r){t._lastModified=n,e(n)}})})}},{key:"getLastModified",value:function(){var e=this;return this.open().then(function(){return new Promise(function(t,n){var r=e.prepare(void 0,"__meta__"),a=r.transaction,i=r.store,o=i.get("lastModified");a.onerror=function(e){return n(e.target.error)},a.oncomplete=function(e){t(o.result&&o.result.value||null)}})})}},{key:"gatherLocalChanges",value:function(){return this.list({},{includeDeleted:!0}).then(function(e){return e.data.reduce(function(e,t){return"deleted"!==t._status||t.last_modified?"synced"!==t._status&&e.toSync.push(t):e.toDelete.push(t),e},{toDelete:[],toSync:[]})})}},{key:"pullChanges",value:function(e){var t=this,n=void 0===arguments[1]?{}:arguments[1];return n=Object.assign({lastModified:this.lastModified},n),this.api.fetchChangesSince(this.bucket,this.name,n).then(function(n){return t.importChanges(e,n)})}},{key:"pushChanges",value:function(t){var n=this,r=void 0===arguments[1]?{}:arguments[1],a=r.strategy===e.SERVER_WINS;return r=Object.assign({safe:a},r),this.gatherLocalChanges().then(function(e){var t=e.toDelete,a=e.toSync;return Promise.all([Promise.all(t.map(function(e){return n["delete"](e.id,{virtual:!1})})),n.api.batch(n.bucket,n.name,a,r)])}).then(function(e){var r=_slicedToArray(e,2),a=(r[0],r[1]);return Promise.all(a.published.map(function(e){return e.deleted?n["delete"](e.id,{virtual:!1}).then(function(e){return{data:{id:e.data.id,deleted:!0}}}):n.update(e,{synced:!0})})).then(function(e){return t.add("published",e.map(function(e){return e.data})),t})})}},{key:"sync",value:function(){var t=this,n=void 0===arguments[0]?{strategy:e.strategy.MANUAL,headers:{}}:arguments[0],r=new SyncResultObject;return this.getLastModified().then(function(e){return t._lastModified=e}).then(function(e){return t.pullChanges(r,n)}).then(function(e){return e.ok?t.pushChanges(e,n).then(function(e){return t.pullChanges(e,n)}):e})}}],[{key:"strategy",get:function(){return{CLIENT_WINS:"client_wins",SERVER_WINS:"server_wins",MANUAL:"manual"}}}]),e}();exports["default"]=Collection;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./api":103,"./utils":105,"deep-eql":95,"uuid":102}],105:[function(require,module,exports){
"use strict";function attachFakeIDBSymbolsTo(e){if("object"!=typeof e.indexedDB){var t=["IDBTransaction","IDBObjectStore","IDBIndex","IDBCursor","IDBCursorWithValue","IDBKeyRange"];t.forEach(function(t){var o=t.replace("IDB","FDB");e[t]=require("fake-indexeddb/lib/"+o)}),e.indexedDB=require("fake-indexeddb")}}function quote(e){return'"'+e+'"'}function unquote(e){return e.replace(/^"/,"").replace(/"$/,"")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.attachFakeIDBSymbolsTo=attachFakeIDBSymbolsTo,exports.quote=quote,exports.unquote=unquote;

},{"fake-indexeddb":"fake-indexeddb"}],106:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var o=t[i];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,i,o){return i&&e(t.prototype,i),o&&e(t,o),t}}();require("babel/polyfill"),require("isomorphic-fetch");var _api=require("./api"),_api2=_interopRequireDefault(_api),_collection=require("./collection"),_collection2=_interopRequireDefault(_collection),DEFAULT_BUCKET_NAME="default",Cliquetis=function(){function e(){var t=void 0===arguments[0]?{}:arguments[0];_classCallCheck(this,e),this._options=t,this._collections={}}return _createClass(e,[{key:"collection",value:function(e){if(!e)throw new Error("missing collection name");var t=this._options.bucket||DEFAULT_BUCKET_NAME,i=new _api2["default"](this._options.remote||"http://0.0.0.0:8888/v0",{headers:this._options.headers||{}});return this._collections.hasOwnProperty(e)||(this._collections[e]=new _collection2["default"](t,e,i)),this._collections[e]}}]),e}();exports["default"]=Cliquetis,module.exports=exports["default"];
