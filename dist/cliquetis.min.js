...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function cleanRecord(e){var t=void 0===arguments[1]?RECORD_FIELDS_TO_CLEAN:arguments[1];return Object.keys(e).reduce(function(r,n){return-1===t.indexOf(n)&&(r[n]=e[n]),r},{})}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}();exports.cleanRecord=cleanRecord;var _utilsJs=require("./utils.js"),RECORD_FIELDS_TO_CLEAN=["_status","last_modified"],DEFAULT_REQUEST_HEADERS={Accept:"application/json","Content-Type":"application/json"},Api=function(){function e(t){var r=void 0===arguments[1]?{headers:{}}:arguments[1];if(_classCallCheck(this,e),"string"!=typeof t||!t.length)throw new Error("Invalid remote URL: "+t);this.remote=t,this.optionHeaders=r.headers;try{this.version="v"+t.match(/\/v(\d+)\/?$/)[1]}catch(n){throw new Error("The remote URL must contain the version: "+t)}}return _createClass(e,[{key:"endpoints",value:function(){var e=void 0===arguments[0]?{fullUrl:!0}:arguments[0],t=e.fullUrl?this.remote:"/"+this.version,r={root:function(){return t},batch:function(){return""+t+"/batch"},bucket:function(e){return""+t+"/buckets/"+e},collection:function(e,t){return""+r.bucket(e)+"/collections/"+t},records:function(e,t){return""+r.collection(e,t)+"/records"},record:function(e,t,n){return""+r.records(e,t)+"/"+n}};return r}},{key:"fetchChangesSince",value:function(e,t){var r,n=void 0===arguments[2]?{lastModified:null,headers:{}}:arguments[2],s=this.endpoints().records(e,t),o="",a=Object.assign({},DEFAULT_REQUEST_HEADERS,this.optionHeaders,n.headers);return n.lastModified&&(o="?_since="+n.lastModified,a["If-None-Match"]=_utilsJs.quote(n.lastModified)),fetch(s+o,{headers:a}).then(function(e){if(304===e.status)return r=n.lastModified,{data:[]};if(e.status>=400)throw new Error("Fetching changes failed: HTTP "+e.status);var t=e.headers.get("ETag");return r=parseInt(_utilsJs.unquote(t),10),e.json()}).then(function(e){return{lastModified:r,changes:e.data}})}},{key:"_buildRecordBatchRequest",value:function(e,t,r){var n="deleted"===e._status,s=n?"DELETE":"PUT",o=n?void 0:{data:cleanRecord(e)},a={};return r&&(e.last_modified?a["If-Match"]=_utilsJs.quote(e.last_modified):n||(a["If-None-Match"]="*")),{method:s,headers:a,path:t,body:o}}},{key:"batch",value:function(e,t,r){var n=this,s=void 0===arguments[3]?{headers:{}}:arguments[3],o=s.safe||!0,a=Object.assign({},DEFAULT_REQUEST_HEADERS,this.optionHeaders,s.headers),i={errors:[],published:[],conflicts:[],skipped:[]};return r.length?fetch(this.endpoints().batch(),{method:"POST",headers:a,body:JSON.stringify({defaults:{headers:a},requests:r.map(function(r){var s=n.endpoints({full:!1}).record(e,t,r.id);return n._buildRecordBatchRequest(r,s,o)})})}).then(function(e){return e.json()}).then(function(e){if(e.error)throw Object.keys(e).reduce(function(t,r){return"message"!==r&&(t[r]=e[r]),t},new Error("BATCH request failed: "+e.message));return e.responses.forEach(function(e){e.status&&e.status>=200&&e.status<400?i.published.push(e.body.data):404===e.status?i.skipped.push(e.body):412===e.status?i.conflicts.push({type:"outgoing",data:e.body}):i.errors.push({path:e.path,error:e.body})}),i}):Promise.resolve(i)}}]),e}();exports["default"]=Api;
