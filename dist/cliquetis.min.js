...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function cleanRecord(e){var t=void 0===arguments[1]?RECORD_FIELDS_TO_CLEAN:arguments[1];return Object.keys(e).reduce(function(n,r){return-1===t.indexOf(r)&&(n[r]=e[r]),n},{})}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}();exports.cleanRecord=cleanRecord;var RECORD_FIELDS_TO_CLEAN=["_status","last_modified"],DEFAULT_REQUEST_HEADERS={Accept:"application/json","Content-Type":"application/json"},Api=function(){function e(t){void 0===arguments[1]?{}:arguments[1];if(_classCallCheck(this,e),"string"!=typeof t||!t.length)throw new Error("Invalid remote URL: "+t);this.remote=t;try{this.version="v"+t.match(/\/v(\d+)\/?$/)[1]}catch(n){throw new Error("The remote URL must contain the version: "+t)}}return _createClass(e,[{key:"endpoints",value:function(){var e=this,t=void 0===arguments[0]?{fullUrl:!0}:arguments[0],n=t.fullUrl?this.remote:"/"+this.version;return{root:function(){return n},batch:function(){return""+n+"/batch"},collection:function(e){return""+n+"/collections/"+e+"/records"},record:function(n,r){return""+e.endpoints(t).collection(n)+"/"+r}}}},{key:"fetchChangesSince",value:function(e){var t,n=void 0===arguments[1]?null:arguments[1],r=void 0===arguments[2]?{headers:{}}:arguments[2],s="?"+(n?"_since="+n:"");return fetch(this.endpoints().collection(e)+s,{headers:Object.assign({},DEFAULT_REQUEST_HEADERS,{"If-Modified-Since":n?String(n):"0"},r.headers)}).then(function(e){if(304===e.status)return t=n,{items:[]};if(e.status>=400)throw new Error("Fetching changes failed: HTTP "+e.status);return t=e.headers.get("Last-Modified"),e.json()}).then(function(e){return{lastModified:t,changes:e.items}})}},{key:"batch",value:function(e,t){var n=this,r=void 0===arguments[2]?{}:arguments[2],s=void 0===arguments[3]?{safe:!0}:arguments[3],o={errors:[],published:[],conflicts:[],skipped:[]};return t.length?fetch(this.endpoints().batch(),{method:"POST",headers:DEFAULT_REQUEST_HEADERS,body:JSON.stringify({defaults:{headers:r},requests:t.map(function(t){var r="deleted"===t._status,o=n.endpoints({full:!1}).record(e,t.id),i=r?"DELETE":"PUT",a=r?void 0:cleanRecord(t),u=s.safe?{"If-Unmodified-Since":String(t.last_modified||"0")}:{};return{method:i,headers:u,path:o,body:a}})})}).then(function(e){return e.json()}).then(function(e){if(e.error)throw Object.keys(e).reduce(function(t,n){return"message"!==n&&(t[n]=e[n]),t},new Error("BATCH request failed: "+e.message));return e.responses.forEach(function(e){e.status&&e.status>=200&&e.status<400?o.published.push(e.body):404===e.status?o.skipped.push(e.body):412===e.status?o.conflicts.push({type:"outgoing",data:e.body}):o.errors.push({path:e.path,error:e.body})}),o}):Promise.resolve(o)}}]),e}();exports["default"]=Api;

},{}],104:[function(require,module,exports){
(function (global){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _slicedToArray(e,t){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e)){var r=[],n=!0,a=!1,i=void 0;try{for(var o,u=e[Symbol.iterator]();!(n=(o=u.next()).done)&&(r.push(o.value),!t||r.length!==t);n=!0);}catch(s){a=!0,i=s}finally{try{!n&&u["return"]&&u["return"]()}finally{if(a)throw i}}return r}throw new TypeError("Invalid attempt to destructure non-iterable instance")}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_uuid=require("uuid"),_deepEql=require("deep-eql"),_deepEql2=_interopRequireDefault(_deepEql),_utils=require("./utils"),_api=require("./api");_utils.attachFakeIDBSymbolsTo("object"==typeof global?global:window);var SyncResultObject=function(){function e(){_classCallCheck(this,e),Object.assign(this,e.defaults)}return _createClass(e,[{key:"add",value:function(e,t){Array.isArray(this[e])&&(this[e]=this[e].concat(t),this.ok=this.errors.length+this.conflicts.length===0)}}],[{key:"defaults",get:function(){return{ok:!0,lastModified:null,errors:[],created:[],updated:[],deleted:[],published:[],conflicts:[],skipped:[]}}}]),e}();exports.SyncResultObject=SyncResultObject;var Collection=function(){function e(t,r){_classCallCheck(this,e),this._name=t,this._db,this.api=r,this._lastModified=null}return _createClass(e,[{key:"name",get:function(){return this._name}},{key:"lastModified",get:function(){return this._lastModified}},{key:"_handleError",value:function(e){return function(t){throw new Error(e+"() "+(t&&t.message||"unknown"))}}},{key:"open",value:function(){var e=this;return this._db?Promise.resolve(this):new Promise(function(t,r){var n=indexedDB.open(e.name,1);n.onupgradeneeded=function(t){var r=t.target.result,n=r.createObjectStore(e.name,{keyPath:"id"});n.createIndex("id","id",{unique:!0}),n.createIndex("_status","_status"),n.createIndex("last_modified","last_modified");var a=r.createObjectStore("__meta__",{keyPath:"name"});a.createIndex("name","name",{unique:!0})},n.onerror=function(e){return r(e.target.error)},n.onsuccess=function(r){e._db=r.target.result,t(e)}})}},{key:"prepare",value:function(){var e=void 0===arguments[0]?void 0:arguments[0],t=void 0===arguments[1]?null:arguments[1],r=t||this.name,n=this._db.transaction([r],e),a=n.objectStore(r);return{transaction:n,store:a}}},{key:"clear",value:function(){var e=this;return this.open().then(function(){return new Promise(function(t,r){var n=e.prepare("readwrite"),a=n.transaction,i=n.store;i.clear(),a.onerror=function(e){return r(new Error(e.target.error))},a.oncomplete=function(e){t({data:[],permissions:{}})}})})["catch"](this._handleError("clear"))}},{key:"create",value:function(e){var t=this,r=void 0===arguments[1]?{synced:!1}:arguments[1];return this.open().then(function(){return"object"!=typeof e?Promise.reject(new Error("Record is not an object.")):new Promise(function(n,a){var i=t.prepare("readwrite"),o=i.transaction,u=i.store,s=Object.assign({},e,{id:r.synced?e.id:_uuid.v4(),_status:r.synced?"synced":"created"});u.add(s),o.onerror=function(e){return a(new Error(e.target.error))},o.oncomplete=function(e){n({data:s,permissions:{}})}})})["catch"](this._handleError("create"))}},{key:"update",value:function(e){var t=this,r=void 0===arguments[1]?{synced:!1}:arguments[1];return this.open().then(function(){return"object"!=typeof e?Promise.reject(new Error("Record is not an object.")):e.id?t.get(e.id).then(function(n){return new Promise(function(n,a){var i="updated";"deleted"===e._status?i="deleted":r.synced&&(i="synced");var o=t.prepare("readwrite"),u=o.transaction,s=o.store,d=Object.assign({},e,{_status:i}),c=s.put(d);u.onerror=function(e){return a(new Error(e.target.error))},u.oncomplete=function(e){n({data:Object.assign({},d,{id:c.result}),permissions:{}})}})}):Promise.reject(new Error("Cannot update a record missing id."))})["catch"](this._handleError("update"))}},{key:"resolve",value:function(e,t){return this.update(Object.assign({},t,{last_modified:e.remote.last_modified}))}},{key:"get",value:function(e){var t=this,r=void 0===arguments[1]?{includeDeleted:!1}:arguments[1];return this.open().then(function(){return new Promise(function(n,a){var i=t.prepare(),o=i.transaction,u=i.store,s=u.get(e);o.onerror=function(e){return a(new Error(e.target.error))},o.oncomplete=function(t){!s.result||!r.includeDeleted&&"deleted"===s.result._status?a(new Error("Record with id="+e+" not found.")):n({data:s.result,permissions:{}})}})})["catch"](this._handleError("get"))}},{key:"delete",value:function(e){var t=this,r=void 0===arguments[1]?{virtual:!0}:arguments[1];return this.open().then(function(){return t.get(e,{includeDeleted:!0}).then(function(n){return r.virtual?"deleted"===n.data._status?Promise.resolve({data:{id:e},permissions:{}}):t.update(Object.assign({},n.data,{_status:"deleted"})):new Promise(function(r,n){var a=t.prepare("readwrite"),i=a.transaction,o=a.store;o["delete"](e),i.onerror=function(e){return n(new Error(e.target.error))},i.oncomplete=function(t){r({data:{id:e},permissions:{}})}})})})["catch"](this._handleError("delete"))}},{key:"list",value:function(){var e=this,t=(void 0===arguments[0]?{}:arguments[0],void 0===arguments[1]?{includeDeleted:!1}:arguments[1]);return this.open().then(function(){return new Promise(function(r,n){var a=[],i=e.prepare(),o=i.transaction,u=i.store,s=u.openCursor();s.onsuccess=function(e){var r=e.target.result;r&&((t.includeDeleted||"deleted"!==r.value._status)&&a.push(r.value),r["continue"]())},o.onerror=function(e){return n(new Error(e.target.error))},o.oncomplete=function(e){r({data:a,permissions:{}})}})})["catch"](function(t){console.log("err",t),e._handleError("list")(t)})}},{key:"_importChange",value:function(e){var t=this;return this.get(e.id,{includeDeleted:!0}).then(function(r){return"synced"!==r.data._status?"deleted"===r.data._status?{type:"skipped",data:r.data}:_deepEql2["default"](_api.cleanRecord(r.data),_api.cleanRecord(e))?t.update(e,{synced:!0}).then(function(e){return{type:"updated",data:e.data}}):{type:"conflicts",data:{type:"incoming",local:r.data,remote:e}}:e.deleted?t["delete"](e.id,{virtual:!1}).then(function(e){return{type:"deleted",data:e.data}}):t.update(e,{synced:!0}).then(function(e){return{type:"updated",data:e.data}})})["catch"](function(r){return/not found/i.test(r.message)?e.deleted?{type:"skipped",data:e}:t.create(e,{synced:!0}).then(function(e){return{type:"created",data:e.data}}):{type:"errors",data:r}})}},{key:"importChanges",value:function(e,t){var r=this;return Promise.all(t.changes.map(function(e){return r._importChange(e)})).then(function(t){var r=!0,n=!1,a=void 0;try{for(var i,o=t[Symbol.iterator]();!(r=(i=o.next()).done);r=!0){var u=i.value;e.add(u.type,u.data)}}catch(s){n=!0,a=s}finally{try{!r&&o["return"]&&o["return"]()}finally{if(n)throw a}}return e}).then(function(e){return e.lastModified=t.lastModified,e.conflicts.length>0?e:r.saveLastModified(e.lastModified).then(function(t){return e})})}},{key:"saveLastModified",value:function(e){var t=this,r=parseInt(e,10);return this.open().then(function(){return new Promise(function(e,n){var a=t.prepare("readwrite","__meta__"),i=a.transaction,o=a.store;o.put({name:"lastModified",value:r});i.onerror=function(e){return n(e.target.error)},i.oncomplete=function(n){t._lastModified=r,e(r)}})})}},{key:"getLastModified",value:function(){var e=this;return this.open().then(function(){return new Promise(function(t,r){var n=e.prepare(void 0,"__meta__"),a=n.transaction,i=n.store,o=i.get("lastModified");a.onerror=function(e){return r(e.target.error)},a.oncomplete=function(e){t(o.result&&o.result.value||null)}})})}},{key:"gatherLocalChanges",value:function(){return this.list({},{includeDeleted:!0}).then(function(e){return e.data.reduce(function(e,t){return"deleted"!==t._status||t.last_modified?"synced"!==t._status&&e.toSync.push(t):e.toDelete.push(t),e},{toDelete:[],toSync:[]})})}},{key:"pullChanges",value:function(e,t){var r=this;return this.api.fetchChangesSince(this.name,this.lastModified,t).then(function(t){return r.importChanges(e,t)})}},{key:"pushChanges",value:function(t){var r=this,n=void 0===arguments[1]?{headers:{}}:arguments[1];return this.gatherLocalChanges().then(function(t){var a=t.toDelete,i=t.toSync;return Promise.all([Promise.all(a.map(function(e){return r["delete"](e.id,{virtual:!1})})),r.api.batch(r.name,i,n.headers,{safe:n.strategy===e.SERVER_WINS})])}).then(function(e){var n=_slicedToArray(e,2),a=(n[0],n[1]);return Promise.all(a.published.map(function(e){return e.deleted?r["delete"](e.id,{virtual:!1}).then(function(e){return{data:{id:e.data.id,deleted:!0}}}):r.update(e,{synced:!0})})).then(function(e){return t.add("published",e.map(function(e){return e.data})),t})})}},{key:"sync",value:function(){var t=this,r=void 0===arguments[0]?{strategy:e.strategy.MANUAL,headers:{}}:arguments[0],n=new SyncResultObject;return this.getLastModified().then(function(e){return t._lastModified=e}).then(function(e){return t.pullChanges(n,r)}).then(function(e){return e.ok?t.pushChanges(e,r).then(function(e){return t.pullChanges(e,r)}):e})}}],[{key:"strategy",get:function(){return{CLIENT_WINS:"client_wins",SERVER_WINS:"server_wins",MANUAL:"manual"}}}]),e}();exports["default"]=Collection;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./api":103,"./utils":105,"deep-eql":95,"uuid":102}],105:[function(require,module,exports){
"use strict";function attachFakeIDBSymbolsTo(e){if("object"!=typeof e.indexedDB){var a=["IDBTransaction","IDBObjectStore","IDBIndex","IDBCursor","IDBCursorWithValue","IDBKeyRange"];a.forEach(function(a){var t=a.replace("IDB","FDB");e[a]=require("fake-indexeddb/lib/"+t)}),e.indexedDB=require("fake-indexeddb")}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.attachFakeIDBSymbolsTo=attachFakeIDBSymbolsTo;

},{"fake-indexeddb":"fake-indexeddb"}],106:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var o=t[i];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,i,o){return i&&e(t.prototype,i),o&&e(t,o),t}}();require("babel/polyfill"),require("isomorphic-fetch");var _api=require("./api"),_api2=_interopRequireDefault(_api),_collection=require("./collection"),_collection2=_interopRequireDefault(_collection),Cliquetis=function(){function e(){var t=void 0===arguments[0]?{}:arguments[0];_classCallCheck(this,e),this._options=t,this._collections={}}return _createClass(e,[{key:"collection",value:function(e){if(!e)throw new Error("missing collection name");var t=new _api2["default"](this._options.remote||"http://0.0.0.0:8888/v0");return this._collections.hasOwnProperty(e)||(this._collections[e]=new _collection2["default"](e,t)),this._collections[e]}}]),e}();exports["default"]=Cliquetis,module.exports=exports["default"];
