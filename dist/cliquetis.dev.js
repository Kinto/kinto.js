...
var Api = (function () {
  ...
  _createClass(Api, [{
    ...
    value: function fetchChangesSince(bucketName, collName) {
      ...
      var url = this.endpoints().collection(collName) + queryString;
