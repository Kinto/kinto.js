...
var Api = (function () {
  ...
  _createClass(Api, [{
    ...
    value: function endpoints() {
      ...
      if (options.fullUrl) rootPath = this.remote + rootPath;
      var urls = {
        root: function root() {
          return rootPath;
        },
        ...
        bucket: function bucket(_bucket) {
          return "" + rootPath + "/buckets/" + _bucket;
        },
     ...
     * @return {Promise}
     */
    value: function checkServerVersion() {
      var _this = this;
      ...
      return fetch(this.remote, { headers: DEFAULT_REQUEST_HEADERS }).then(function (res) {
        return res.json();
      }).then(function (res) {
        try {
          _this.serverVersion = res.url.match(/\/(v\d+)\/?$/)[1];
        } catch (err) {
          throw new Error("Remote URL version couldn't be checked; " + err.message);
        }
        return check(_this.serverVersion);
      });
    }
  }, {
    ...
    value: function fetchChangesSince(bucketName, collName) {
      ...
      var newLastModified;
      return this.checkServerVersion().then(function () {
        var recordsUrl = _this2.endpoints().records(bucketName, collName);
        var queryString = "";
        var headers = Object.assign({}, DEFAULT_REQUEST_HEADERS, _this2.optionHeaders, options.headers);
    ...
    value: function batch(bucketName, collName, records) {
      ...
      return this.checkServerVersion().then(function () {
        ...
        var headers = Object.assign({}, DEFAULT_REQUEST_HEADERS, _this3.optionHeaders, options.headers);
        if (!records.length) return Promise.resolve(results);
        return fetch(_this3.endpoints().batch(), {
          method: "POST",
          headers: headers,
          body: JSON.stringify({
