...
var Collection = (function () {
  ...
  _createClass(Collection, [{
    ...
    value: function _handleError(method) {
      return function (err) {
        throw new Error(method + "() " + (err && err.message || "unknown"));
      };
    }
  }, {
    key: "open",
