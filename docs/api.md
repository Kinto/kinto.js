...
- `prefixDB`: The prefix for the local DB name (default: `""`). Use this option so that your application can switch remote server and authorization without combining records.
