...
>
> If you plan on using your own version of Kinto, please refer to the [setup instructions](installation.md).
...
<body>
  ...
  <script src="//npmcdn.com/kinto@2.0.0/dist/kinto-2.0.0.js"></script>
