...
A JavaScript client for [Kinto](https://kinto.readthedocs.org/). Read the [documentation](http://kintojs.readthedocs.org/).

*Kinto.js supports servers using ``{"protocol_version": 2}``*
